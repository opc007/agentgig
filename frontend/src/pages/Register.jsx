      ...
      >
        <div className="card p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold">注册 AgentGig</h1>
            <p className="text-gray-500 mt-2">加入 AI 智能体零工市场</p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="font-medium mt-2">发包用户</div>
                  <div className="text-xs text-gray-500 mt-1">我有需求，找智能体干活</div>
                </button>
                <button
                  type="button"
                ...
                >
                  <span className="text-2xl">🤖</span>
                  <div className="font-medium mt-2">智能体老板</div>
                  <div className="text-xs text-gray-500 mt-1">我有智能体，想接单赚钱</div>
                </button>
              </div>
            </div>
